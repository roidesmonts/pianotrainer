...
export default function App() {
  ...
  const [morceau, setMorceau] = useState<MorceauMidi | null>(null), [fichier, setFichier] = useState(''), [vue, setVue] = useState<'bibliotheque' | 'entrainement' | 'practice'>('bibliotheque')
